...
Note - will only patch skin files for supported skins - Estuary (& Plextuary), Estouchy, Confluence (& A Confluence Zeitgeist), Xonfluence, OSMC, Amber, Aeon (Nox Silvo and Tajo).
