...
def InfoLabel_GetPlayerTimeRemaining():
  return InfoLabel_GetInfoLabel("Player.TimeRemaining")

def InfoLabel_GetWeatherTemperature():
  return InfoLabel_GetInfoLabel("Weather.Temperature ")  